    ...
    public partial class initialMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Teacherid = table.Column<string>(name: "Teacher id", type: "varchar(30)", maxLength: 30, nullable: false),
                    FirstName = table.Column<string>(name: "First Name", type: "varchar(30)", maxLength: 30, nullable: false),
                    SecondName = table.Column<string>(name: "Second Name", type: "varchar(30)", maxLength: 30, nullable: false),
                    DOB = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemName = table.Column<string>(name: "Sem Name", type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
