...
export default function Home() {
  return (
    ...
    <Outlet/>
      <div className="slide-1" style={{backgroundImage: `url('images/hero_1.jpg')`}} >
            ...
            <div className="col-12">
              <div className="row align-items-center">
                <div className="col-lg-6 mb-4">
                  ...
                  <p ><a href="#" className="btn btn-primary py-3 px-5 btn-pill">Admission Now</a></p>
          ...
          <div className="owl-carousel col-12 nonloop-block-14">
            ...
            <div className="course bg-white h-100 align-self-stretch">
              <figure className="m-0">
                <a href="course-single.html"><img src={Img1} alt="Image" className="img-fluid" /></a>
              </figure>
